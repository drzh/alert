...
from alert.solar_prominence_history import update_history
...
def test_update_solar_prominence_history_upserts_current_record(tmp_path: Path) -> None:
    ...
    history_file.write_text(
        "\n".join(
            [
                ...
                "2026-04-25T06:00:00.000\t100",
                "2026-04-25T07:24:53.136\t111",
            ]
        )
        + "\n",
        encoding="utf-8",
    ...
    assert history_file.read_text(encoding="utf-8") == (
        "obs_time\tintensity_max\n"
        "2026-04-25T06:00:00.000\t100\n"
        "2026-04-25T07:24:53.136\t294.625\n"
    )
